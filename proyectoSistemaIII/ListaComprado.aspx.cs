...
{
    public partial class ListaComprado : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                ...
                // se obtendra la session cuando se logee y tambien se obtendra el correo electronico
                //lblCliente.Text = Session["usuario"];
                //lblEmail.Text = Session["usuario"];
            }
        }
        private void Ultimo()
        {
        ...
        protected void Button1_Click_actualizar(object sender, EventArgs e)
        {
            int i;
        ...
        protected void Button2_Click_continuar(object sender, EventArgs e)
        {
            Response.Redirect("CompraCarrito.aspx");
        }

        protected void Button3_Click_comprar(object sender, EventArgs e)
        {
            if (lblCliente.Text == "" || lblemail.Text == "")
            {
                this.Response.Write("<script language='JavaScript'>window.alert('Ingresa tus datos correctamente')</script>");
            }
            else
            {
